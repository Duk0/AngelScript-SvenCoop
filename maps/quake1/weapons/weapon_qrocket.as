...
*/
	...
	void PrimaryAttack()
	{
		...
		CBaseEntity@ pGrenade = q1_ShootCustomProjectile( "projectile_qrocket", "models/quake1/rocket.mdl", 
															vecSrc, vecAiming * 1000, m_pPlayer.pev.v_angle, m_pPlayer );
		if ( pGrenade !is null )
...
void q1_RegisterWeapon_ROCKET()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_qrocket", "quake1/weapons", "rockets", "", "ammo_qrockets" );
}
