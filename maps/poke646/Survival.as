...
final class Survival
{
		...
		else
		{
			...
			do {
				...
				if (ent !is null)
				{
					...
					if (ent.pev.targetname == "checkpoint_trig" and ent.pev.targetname == "mm_checkpoint")
					{
						ent.pev.target = "mm_checkpoint_survival"; // po_c4m6 survival fix
					}
				}
			} while (ent !is null);
		}
	...
	*/
	...
	void StartEndVote()
	{
		Vote vote( "Poke646 end map vote", "Choose to restart the map or go to the next one.", m_flVoteTime, 50 );
