...
class point_checkpoint : ScriptBaseEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "sprites/e-tele1.spr" );
		
		g_SoundSystem.PrecacheSound( "vendetta/misc/checkpoint_survival.wav" );
		g_SoundSystem.PrecacheSound( "vendetta/misc/checkpoint_pulse.wav" );
		g_SoundSystem.PrecacheSound( self.pev.message );
		g_SoundSystem.PrecacheSound( "vendetta/misc/checkpoint_close.wav" );
	}
	
	void SetupModel()
	{
		if( string( self.pev.model ).IsEmpty() )
			g_Game.PrecacheModel( "models/vendetta/misc/checkpoint.mdl" );
		else
	...
	void Spawn()
	{
		...
		if( string( self.pev.model ).IsEmpty() )
			g_EntityFuncs.SetModel( self, "models/vendetta/misc/checkpoint.mdl" );
		else
			g_EntityFuncs.SetModel( self, self.pev.model );
			
		if( string( self.pev.message ).IsEmpty() )
			self.pev.message = "vendetta/misc/checkpoint_pulse.wav";
	...
	void Touch( CBaseEntity@ pOther )
	{
		...
		g_SoundSystem.EmitSound( self.edict(), CHAN_STATIC, "vendetta/misc/checkpoint_survival.wav", 1.0f, ATTN_NONE );
	...
	void RespawnStartThink()
	{
		...
		@m_pSprite = g_EntityFuncs.CreateSprite( "sprites/e-tele1.spr", self.pev.origin, true, 10 );
		m_pSprite.TurnOn();
	...
	{
		g_SoundSystem.EmitSound( self.edict(), CHAN_STREAM, "vendetta/misc/checkpoint_close.wav", 1.0f, ATTN_NORM );
